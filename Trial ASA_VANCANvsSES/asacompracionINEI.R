...
#kml <- st_read("Alto Selva Alegre_Mz.kml")
...
merge_mz<-read.csv("~/PETM-shiny/autoModel/model/input/MERGES_BLOCKS_GPS_ROCIADO/asa_gps_rociado.csv")
...
data_mz <- readOGR("~/Spatial-surveillance/INEI_information_by_block/Mapa/Mz_PrincipalesCiudades.shp", 
...
data_pob <- read_xlsx("~/Spatial-surveillance/INEI_information_by_block/Dato/Poblacion_1.xlsx") # old
